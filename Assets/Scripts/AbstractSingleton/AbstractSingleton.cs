...
public abstract class Singleton<AudioSettings> : MonoBehaviour where AudioSettings : MonoBehaviour
{

    public static AudioSettings _instance = null;
    ...
    public static AudioSettings Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = (AudioSettings)FindObjectOfType(typeof(AudioSettings));
                if (_instance == null)
                {

                    string goName = typeof(AudioSettings).ToString();
